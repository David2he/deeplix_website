    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.cameraImgContainer}>
                <div
                    className={` ${style.imgContainerLoader} ${
                        fadeOutLoading ? style.fadeOut : null
                    }`}
                >
                    <span></span>
                    <span></span>
                ...
                <div
                    className={`${step > 1 ? style.easyAppear : null} ${
                        style.imgContainerLoaded
                    }`}
                >
                    <Image
                        src="/buyDeepOne/DEEP-01.png"
                        alt="logo"
                        width={300}
                        height={400}
                    />
            ...
            <div className={style.allButtonContainer}>
                ...
                <div
                    className={`${style.doubleButtonContainer} ${
                        step === 3 ? style.appear : null
                    }`}
                >
                    <div
                        className={style.whiteButton}
                        onClick={() => navigateThrougStep("back")}
                    >
                        <p>DON'T ALLOW</p>
                    </div>
                    <div
            ...
            {step === 3 ? (
                <div
                    className={`${style.textContainerStep2}  ${
                        step === 3 ? style.appear : null
                    }`}
                >
