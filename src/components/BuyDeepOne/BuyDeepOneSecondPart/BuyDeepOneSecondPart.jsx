...
export const BuyDeepOneSecondPart = ({ step, setStep }) => {
  ...
  const renderBetween4And5 = () => {
    return (
      <>
        <p>
          Place yourself in front of the camera and we'll proceed to scan your facial expressions.
        </p>
    ...
    return (
      <div className={style.container5And6}>
        <div className={style.scanningPContainer}>
          ...
          <div
            className={
              inBetweenFinishTextGeneration ? style.isScanningDOT : style.finishScanningDOT
            }
          >
            <span></span>
            <span></span>
  ...
  const renderBetween6And7 = () => {
    return (
      <div className={style.container6And7}>
        <div
          className={`${style.titleText} ${!appearBlock6to7 === 6 ? null : style.block67CanAppear}`}
        >
          <p>
            Please read this excerpt from Fight Club®, 1999, David Fincher out loud, articulating :
          </p>
        </div>
        <div
          className={`${style.italicText} ${
            !appearBlock6to7 === 6 ? null : style.block67CanAppear
          }`}
        >
          <p>
            Warning: If you are reading this then thiswarning is for you. Every word you read of
            this useless fine print is another second of your life. Don't you have other things to
            do? Is your life so empty that you honestly can't think etter way to spend these
            moments? Or are you so impressed with authority that you give respect and credence to
            all that claim it? Do you read everything you're supposed to read? Do you think every
            thing you're supposed to think? Buy what you're told to want? Get out of your apartment.
            Meet a member of the opposite sex. Stop the excessive shopping and masturbation. Quit
            your job. Start a fight. Prove you're alive. If you don't claim your humanity you will
            become a statistic.
          </p>
        </div>
      </div>
  ...
  useEffect(() => {
    let timerForStep4, timerForStep5_1, timerForStep5_2, timerForStep5_3, timerForStep6_1;
